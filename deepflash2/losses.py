...
__all__ = ['LOSSES', 'FastaiLoss', 'WeightedLoss', 'JointLoss', 'to_tensor', 'get_loss']
...
# Cell
#temporary fix (see https://github.com/qubvel/segmentation_models.pytorch/pull/396)
import numpy as np
...
def get_loss(loss_name, mode='multiclass', classes=[1], smooth_factor=0., alpha=0.5, beta=0.5, gamma=2.0, reduction='mean', **kwargs):
    ...
    if loss_name=="SoftCrossEntropyLoss":
        ...
        # temporary fix classes fix (see https://github.com/qubvel/segmentation_models.pytorch/pull/396)
        loss.classes = to_tensor(classes)
