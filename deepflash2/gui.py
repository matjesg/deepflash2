...
__all__ = ['GRID_COLS', 'COLS_PRED_KEEP', 'COLS_PRED_KEEP_CP', 'set_css_in_cell_output', 'tooltip_css', 'ZipUpload',
           'ItemsPerPage', 'BaseParamWidget', 'BaseUI', 'PathSelector', 'PathDownloads', 'PathConfig', 'ResultWidget',
           'GTDataSB', 'GTEstSB', 'GTEstUI', 'TrainDataSB', 'TrainModelSB', 'TrainValidSB', 'LRWidget',
...
class GTDataSB(BaseParamWidget, GetAttr):
    ...
    #Hints
    txt = 'Provide binary masks or instance labels'
    hints = w.Label(txt)
