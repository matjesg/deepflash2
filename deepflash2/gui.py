...
__all__ = ['GRID_COLS', 'COLS_PRED_KEEP', 'COLS_PRED_KEEP_DS', 'COLS_PRED_KEEP_CP', 'SAMPLE_DATA_URL',
           'exception_handler', 'log_dir', 'today', 'logger', 'ipython', 'err_out', 'set_css_in_cell_output',
...
def exception_handler(exception_type, exception, traceback):
    with err_out:
        print('Ups... Something went wrong! Please revise your input and retry!',f'\nError message: {exception}.', file=sys.stderr)
        display(w.HTML('<hr>'))
...
class GUI(GetAttr):
    ...
    def __init__(self, path=Path('.'), reinit=False):
        ...
        self.box_err = w.VBox(children=[err_out], layout=w.Layout(grid_area='error', flex_flow='column', align_items='flex-start'))
