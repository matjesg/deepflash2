...
# Cell
def unet_ronneberger2015(in_channels=1 ,n_classes=2, pretrained=False, dataset='wue1_cFOS', progress=True, **kwargs):
    ...
    model = UNet2D(in_channels=in_channels, n_classes=n_classes,
                   ...
                   neg_slope=0., up_mode='upconv', **kwargs)
    if pretrained:
        _load_pretrained(model, dataset, progress)
    return model

# Cell
def unet_falk2019(in_channels=1 ,n_classes=2, pretrained=False, dataset='wue1_cFOS', progress=True, **kwargs):
...
# Cell
def unet_deepflash2(in_channels=1 ,n_classes=2, pretrained=False, dataset='wue1_cFOS', progress=True, **kwargs):
